...
void mat_mul_bfv()
{
    ...
    string input_file_name = "native/trec07_data_spam_filter/vec_4000/trec07_email_X_test_vector_length_4000_entire_Apr-06-2021_100.csv";
    string w1_file_name = "native/trec07_data_spam_filter/vec_4000/vec_4000_weight_1.csv";
    string w2_file_name = "native/trec07_data_spam_filter/vec_4000/vec_4000_weight_2.csv";
    string w3_file_name = "native/trec07_data_spam_filter/vec_4000/vec_4000_weight_3.csv";
    string w4_file_name = "native/trec07_data_spam_filter/vec_4000/vec_4000_weight_4.csv";
    ...
    for (int i=0; i < input_vector_size; i++)
    {
        ...
        vector_X[i+input_vector_size] = input_email_vector[test_index][i];
    }
