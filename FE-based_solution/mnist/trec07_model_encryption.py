...
ModelName = "trec07_SpamModel_{}-40-2-20-2-quadnet_reLu".format(inputLength) # + today.strftime("%b-%d-%Y")
...
dir = "trained_quadNet_reLu/vec-5000" #/home/ubuntu/tham_project/corey/project/reading-in-the-dark/mnist/trained_quadNet_reLu/vec-2000/
